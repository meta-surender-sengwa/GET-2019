...
public class SolveFixXYProblemTest {
	...
	public SolveFixXYProblemTest(int[] expectedResult, int[] inputArray, int X, int Y) {
	...
	public void testMaxMirror() {
		assertArrayEquals(expectedResult, arrOperations.solveFixXYProblem(inputArray, X, Y));
	}
}
