...
public class ShowFriendProfile extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			pw.println("<h1>Friends Profile</h1><br><br>");
			
			while (rs.next()) {
				
				pw.println("Employee ID: <input type=\"text\" name=\"id\" value=" + rs.getInt(1) + "> <br><br>");
			...
			pw.print("<input type=\"submit\" value=\"Home\">");
			pw.println("</form>");
